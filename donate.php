    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <img class="KidsImg" src="assets/images/sam/kids.jpeg" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6">
                <div class="text-wrapper mb-50 wow fadeInLeft">
                    <div class="section-title mb-30">
                        <span class="sub-title st-one">Contributes</span>
                        <h2>Join us in supporting Samidoh's mission to uplift Kenyan youth.</h2>
                    </div>
                    <p>Enter your details in the form. This is optional and you may choose to remain anonymous.</p>
                </div>
            </div>
            <div class="col-lg-6">
                    ...
                    <div class="contact-form">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form_group">
                                        <button class="main-btn arrow-btn">Donate</button>
                                    </div>
                                </div>
                            </div>
                        </form>
