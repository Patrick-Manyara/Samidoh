            ...
            <div class="col-lg-6">
                <div class="text-wrapper mb-50 wow fadeInRight">
                    <div class="section-title mb-15">
                        <span class="sub-title st-one">About Samidoh</span>
                        <h2>Discover the Man Behind the Music</h2>
                    </div>

                    <p>
                        Samidoh's unique blend of Benga, Jazz, and RnB has made him a household name in Kenya and across East Africa. Learn about his humble beginnings, struggles, and unwavering determination to create a better life for himself and his family.

                        Delve into Samidoh's early life, marked by tragedy and resilience.
                    </p>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="section-title text-center mb-55 wow fadeInUp">
                    <span class="sub-title st-one">His Story</span>
...
<section class="contact-area contact-area-v1 pt-70 pb-80" style="margin-top: 150px;" id="contact">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8">
